...
def get_youtube_video(game_name: str) -> str:
    """Lekér egy releváns YouTube gameplay videót az adott játékhoz."""
    try:
...
def generate_post(game):
    ...
    safe_name = safe_filename(game['name'])
    filename = f"{timestamp}-{safe_name}.html"
